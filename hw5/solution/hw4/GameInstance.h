...
public:
    ...
    // Saves the entire initial and current game state to json.
    // Throws an illegal argument exception on error.
    json_t* save();

    // Loads the entire initial and current game state from json.
    // Requires valid candy crush json.
